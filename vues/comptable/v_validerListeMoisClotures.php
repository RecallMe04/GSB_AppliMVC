...
<div class="row">
    ...
    <div class="col-md-6">
        <div style="text-align: center;"><h3>S&eacute;lectionner un mois cl&ocirc;tur&eacute;</h3>
        </div>
        <form action="index.php?uc=validerFrais&action=afficherFrais&idVisiteur=<?php echo htmlspecialchars(
            $leVisiteur
        ) ?>"
              method="post">
