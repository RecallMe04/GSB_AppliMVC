...
/**
 * (Comptable) Vue Liste des mois validés
 *
 * PHP Version 7
 *
 * @category  PPE
...
<div class="row">
    ...
    <div class="col-md-6">
        <div style="text-align: center;"><h3>S&eacute;lectionner un mois valid&eacute;e</h3></div>
        <form action="index.php?uc=suiviFrais&action=afficherFrais&idVisiteur=<?php echo htmlspecialchars($leVisiteur) ?>"
              method="post">
